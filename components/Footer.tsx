    ...
    <footer className="w-full bg-[#070708] text-zinc-400 border-t border-zinc-900 pt-16 pb-8 font-sans transition-colors duration-500">
      <div className="max-w-[1400px] mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b border-zinc-900">
        ...
        <div className="md:col-span-4 space-y-5">
          <Link href="/" className="inline-flex items-center gap-2 text-white font-extrabold text-sm uppercase tracking-widest">
            ...
            <span>Hossen Software Shop</span>
          </Link>
          <p className="text-zinc-500 text-xs leading-relaxed max-w-sm">
            Elite engineering agency and template marketplace turning complex business ideas into high-performance, production-ready full-stack software.
          </p>
        ...
        <div className="md:col-span-2 space-y-4">
          ...
          <ul className="space-y-2.5 text-xs text-zinc-500 font-semibold">
            <li>
              <Link href="/products" className="hover:text-zinc-300 transition-colors">SaaS Boilerplates</Link>
            </li>
            <li>
              <Link href="/products" className="hover:text-zinc-300 transition-colors">Mobile App Templates</Link>
            </li>
            <li>
              <Link href="/products" className="hover:text-zinc-300 transition-colors">Full Web Systems</Link>
            </li>
            <li>
              <Link href="/products" className="hover:text-zinc-300 transition-colors">UI/UX Kits</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="md:col-span-2 space-y-4">
          ...
          <ul className="space-y-2.5 text-xs text-zinc-500 font-semibold">
            <li>
              <Link href="/services/custom-saas" className="hover:text-zinc-300 transition-colors">Custom SaaS Builds</Link>
            </li>
            <li>
              <Link href="/services/web-engineering" className="hover:text-zinc-300 transition-colors">Web Systems</Link>
            </li>
            <li>
              <Link href="/services/mobile-apps" className="hover:text-zinc-300 transition-colors">Mobile Apps</Link>
            </li>
            <li>
              <Link href="/services/cloud-infra" className="hover:text-zinc-300 transition-colors">Cloud & Architecture</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="md:col-span-2 space-y-4">
          ...
          <ul className="space-y-2.5 text-xs text-zinc-500 font-semibold">
            <li>
              <Link href="/estimator" className="hover:text-zinc-300 transition-colors">AI Project Estimator</Link>
            </li>
            <li>
              <Link href="/user" className="hover:text-zinc-300 transition-colors">Client Workspace</Link>
            </li>
            <li>
              <Link href="/user/deals" className="hover:text-zinc-300 transition-colors">Custom Deals</Link>
            </li>
            <li>
              <Link href="/user/support" className="hover:text-zinc-300 transition-colors">Help Desk Support</Link>
            </li>
          </ul>
        </div>
      ...
      <div className="max-w-[1400px] mx-auto px-6 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="flex flex-wrap items-center gap-6 text-[10px] text-zinc-550 font-bold uppercase tracking-wider">
          <span>&copy; {currentYear} Hossen Software Shop. All Rights Reserved.</span>
