...
export default function SignupPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-[#09090b] text-zinc-900 dark:text-zinc-100 flex flex-col justify-center items-center px-4 py-12 transition-colors relative overflow-hidden font-sans">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-zinc-100 dark:bg-zinc-950/20 blur-[100px] pointer-events-none" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-zinc-100 dark:bg-zinc-950/20 blur-[100px] pointer-events-none" />
