...
export const metadata: Metadata = {
  ...
  description: 'Use our free project cost estimator to get an instant quote for your web app, mobile app, or custom software project from Hosen Software Shop.',
  keywords: [
    ...
    'Hosen Software Shop estimator',
  ],
  alternates: {
    canonical: '/estimator',
  },
  openGraph: {
    title: 'Free Project Cost Estimator | Hosen Software Shop',
