...
export const API_BASE_URL =
  process.env.NEXT_PUBLIC_API_URL || 'https://hosen-software-shop-server.vercel.app';
...
export const SOCKET_URL =
  process.env.NEXT_PUBLIC_SOCKET_URL || 'https://hosen-software-shop-server.vercel.app';
